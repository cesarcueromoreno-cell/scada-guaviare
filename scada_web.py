...
/* Textos blancos SOLO para el Login y títulos fuera del panel central */
...
/* PANEL CENTRAL (Fondo blanco translúcido y textos oscuros legibles) */
.block-container { 
...
# ARREGLO DEL ERROR TYPEERROR: Simplemente quitamos el 'type' u otras cosas raras que causaban conflicto
...
# ==========================================
    ...
    # --- GRÁFICA Y FLUJO (DIAGRAMA SVG RESTAURADO) ---
    with t_graf:
        ...
        with col_flujo:
            ...
            # EL HERMOSO DIAGRAMA SVG EXACTO DE TU FOTO
            diagrama_svg = f"""
            <div style="background: white; border-radius: 8px; padding: 20px; border: 1px solid #eaeaea; height: 100%; display: flex; align-items: center;">
                <svg viewBox="0 0 400 350" width="100%">
                    ...
                    <g transform="translate(60,30)">
                        ...
                        <text x="5" y="40" font-size="16" font-weight="bold" fill="#3498db" text-anchor="middle">{d['solar']} W</text>
                    </g>
                    ...
                    <g transform="translate(60,260)">
                        ...
                        <text x="5" y="55" font-size="11" font-weight="bold" fill="{color_bat}" text-anchor="middle">SOC: {d['soc']}%</text>
                    </g>
                    
                    <g transform="translate(260,260)">
                        <image href="https://img.icons8.com/color/48/home.png" width="40" height="40" x="-15" y="-15"/>
                        <text x="5" y="40" font-size="16" font-weight="bold" fill="#e74c3c" text-anchor="middle">{d['casa']} W</text>
                    </g>
                </svg>
            </div>
            """
