...
st.markdown(
    ...
    .tarjeta-planta {
        ...
        margin-bottom: 5px; /* Reducido para pegar con el desplegable */
    }
...
def obtener_datos_reales(planta):
    ...
    if marca == "Fronius" and "." in ip_sn:
        try:
            ...
            energia_diaria = round((pot_sol * 4) / 1000, 1) 
...
# ==========================================
# VENTANA 1: PANORAMA GENERAL (AHORA CON GRÁFICAS POR PLANTA)
# ==========================================
        ...
        for i, pl in enumerate(plantas_guardadas):
            ...
            with st.expander(f"📉 Ver gráfica de comportamiento: {pl['nombre']}", expanded=False):
                ...
                fig.update_layout(
                    ...
                    yaxis_title="Potencia (kW)", margin=dict(l=20, r=20, t=10, b=20), height=300
                )
